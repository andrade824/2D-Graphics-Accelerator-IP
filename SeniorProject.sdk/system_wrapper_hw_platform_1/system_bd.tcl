...
proc create_root_design { parentCell } {
  ...
  set_property -dict [ list CONFIG.CLK_DOMAIN {system_processing_system7_0_0_FCLK_CLK0} CONFIG.FREQ_HZ {125000000}  ] $Ethernet125Mhz
  ...
  set_property -dict [ list CONFIG.C_ALL_INPUTS {1} CONFIG.C_GPIO_WIDTH {3}  ] $btns_gpio

  # Create instance: clk_wiz_0, and set properties
  set clk_wiz_0 [ create_bd_cell -type ip -vlnv xilinx.com:ip:clk_wiz:5.1 clk_wiz_0 ]
  set_property -dict [ list CONFIG.CLKIN1_JITTER_PS {100.0} CONFIG.CLKOUT1_JITTER {116.394} CONFIG.CLKOUT1_PHASE_ERROR {87.466} CONFIG.CLKOUT2_JITTER {155.403} CONFIG.CLKOUT2_PHASE_ERROR {87.466} CONFIG.CLKOUT2_REQUESTED_OUT_FREQ {25.175} CONFIG.CLKOUT2_USED {true} CONFIG.MMCM_CLKFBOUT_MULT_F {9.500} CONFIG.MMCM_CLKIN1_PERIOD {8.0} CONFIG.MMCM_CLKOUT0_DIVIDE_F {11.875} CONFIG.MMCM_CLKOUT1_DIVIDE {47} CONFIG.MMCM_DIVCLK_DIVIDE {1} CONFIG.NUM_OUT_CLKS {2} CONFIG.RESET_PORT {resetn} CONFIG.RESET_TYPE {ACTIVE_LOW} CONFIG.USE_LOCKED {false} CONFIG.USE_RESET {false}  ] $clk_wiz_0
