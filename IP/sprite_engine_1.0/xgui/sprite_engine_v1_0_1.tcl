...
proc init_gui { IPINST } {
  ...
  set C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR [ipgui::add_param $IPINST -name "C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR" -parent ${Page_0}]
  set_property tooltip {Base address of targeted slave} ${C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR}
...
proc update_PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to update C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR { PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to validate C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR
	return true
}
...
proc update_PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH } {
	# Procedure called to update C_M_FRAMEREAD_AXI_AWUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH } {
	# Procedure called to validate C_M_FRAMEREAD_AXI_AWUSER_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH } {
	# Procedure called to update C_M_FRAMEREAD_AXI_WUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH } {
	# Procedure called to validate C_M_FRAMEREAD_AXI_WUSER_WIDTH
	return true
}
...
proc update_PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH } {
	# Procedure called to update C_M_FRAMEREAD_AXI_BUSER_WIDTH when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH { PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH } {
	# Procedure called to validate C_M_FRAMEREAD_AXI_BUSER_WIDTH
	return true
}
...
proc update_MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR { MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR}] ${MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_TARGET_SLAVE_BASE_ADDR}
}
...
proc update_MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH { MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH}] ${MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_AWUSER_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH { MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH}] ${MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_WUSER_WIDTH}
}
...
proc update_MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH { MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH}] ${MODELPARAM_VALUE.C_M_FRAMEREAD_AXI_BUSER_WIDTH}
}
